...
// provide shim for node.js path and fs in browser environemnt
// the path shim comes from Browserify project
require.register("path.js", function(module, exports, require){
 ...
 if (typeof window !== "undefined" && window.navigator && window.document) {
  ...
  require.register("fs.js", function(module, exports, require) {
    exports.readFileSync = requirejsVars.nodeRequire('fs').readFileSync;
  });
}
